/*
Проєкт: Аналіз ефективності email-розсилок та активності акаунтів
Опис: 
    Скрипт зводить дані з різних джерел (акаунти, сесії, email-активність) 
    у єдину структуру для подальшого аналізу. 
    Виконує ранжування країн за активністю користувачів та обсягом розсилок.
Технології: SQL (CTEs, Window Functions, Aggregations)
*/
